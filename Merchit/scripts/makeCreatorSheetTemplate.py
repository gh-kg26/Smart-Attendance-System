...
print("INSIDE CREATOR SHEET TEMPLATE 6")
...
#123123
    ...
    accessories = ['PopGrip' , 'ButtonBadge' , 'Coaster' , 'BlackMug' , 'Mug', 'BlackToteBag', 'ToteBag'  ]
    apparels = ['HALF' , 'FULL' , 'HOODIE' , 'TANK' , 'Sweatshirt' , 'CropHood' , 'WomenHalf' , 'CropTop', 'Jogger' , 'SportsBra' , 'FanBox01' , 'FanBox02' , 'FanBox03' , 'FanBox04' , 'Combo01' , 'Combo02' , 'Combo03' , 'Combo04' , 'OversizedTshirt'] 
