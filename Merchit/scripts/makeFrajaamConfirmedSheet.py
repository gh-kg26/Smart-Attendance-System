...
def makeFrajaamConfirmedSheet(wksOrders , wksOrderItems , wksConfirmed):
    ...
    OrdersDF3 = OrdersDF[OrdersDF['Tags'].str.contains('Converted from COD') | OrdersDF['Tags'].str.contains('Confirmed-CODfirm') | OrdersDF['Payment Method'].str.contains('paytm') |OrdersDF['Payment Method'].str.contains('sezzle_in') | OrdersDF['Payment Method'].str.contains('razorpay_cards_upi_netbanking_wallets_') | OrdersDF['Payment Method'].str.contains('cashfree_upi_cards_wallets_paypal_netbanking')]
